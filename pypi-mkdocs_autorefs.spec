...
Version  : 1.3.0
Release  : 10
URL      : https://files.pythonhosted.org/packages/fe/18/fb1e17fb705228b51bf7b2f791adaf83c0fa708e51bbc003411ba48ae21e/mkdocs_autorefs-1.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/fe/18/fb1e17fb705228b51bf7b2f791adaf83c0fa708e51bbc003411ba48ae21e/mkdocs_autorefs-1.3.0.tar.gz
...
%prep
%setup -q -n mkdocs_autorefs-1.3.0
cd %{_builddir}/mkdocs_autorefs-1.3.0
pushd ..
cp -a mkdocs_autorefs-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736781989
